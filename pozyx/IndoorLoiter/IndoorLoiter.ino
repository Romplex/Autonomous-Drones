...
uint16_t anchor_id[4] = { 0x690b, // (0,0)
                          0x6951, // x-axis
                          0x695d, // y-axis
                          0x6e59};
...
int32_t th = 750;
int32_t anchors_x[NUM_ANCHORS] = {-3638, -3231, 3460, 2081};    // anchor x-coorindates in mm (horizontal)
int32_t anchors_y[NUM_ANCHORS] = {973  , -9997,-1217, -9997};    // anchor y-coordinates in mm (vertical)
int32_t heights[NUM_ANCHORS] =   {-3000+th, -1500+th, -2500+th, -2000+th};    // anchor z-coordinates in mm (1.2m above vehicle's starting altitude)
